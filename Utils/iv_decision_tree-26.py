...
class IVDecisionTreeClassifier(_ConformalMixin, _IVTreeBase, ClassifierMixin):
    """
...
class IVDecisionTreeRegressor(_ConformalMixin, _IVTreeBase, RegressorMixin):
    """
...
class IVDecisionTreeBoostRegressor(_ConformalMixin, BaseEstimator, RegressorMixin):
    """
...
class IVDecisionTreeBoostClassifier(_ConformalMixin, BaseEstimator, ClassifierMixin):
